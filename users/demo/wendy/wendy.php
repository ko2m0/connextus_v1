...
if ($mysqli -> connect_errno) {
  ...
  $sql = "SELECT * FROM connextus_demo_data WHERE user_id='0'";
    ...
    <header class="videoSection">
       <div class="container videocontainer">
         <video playsinline controls class="responsive-video"  
           poster="/images/connextus_thumbnail2.jpg">
    ...
    <main class="mainSection">
        ...
        <div class="container P-2vh">
            ...
            <!--<a href="https://wa.me//?text=Hello%20I%20would%20like%20to%20contact%20you">-->
                    <div class="k-btn">
                        <img src="https://dev.connextusnow.com/images/svg/msg_icon.svg" alt="Message">
                    </div>
            ...
            <div class="one-third">
                <div class="k-btn" id="MeetBtn">
                    <img src="https://dev.connextusnow.com/images/svg/meet_icon.svg" alt="Meeting">
                </div>
                <p class="center-text uppercase unuscolor-txt bold">Meeting</p>
            </div>
            <div class="one-third last-column">
                    <div class="k-btn" id="ReferBtn">
                        <img src="https://dev.connextusnow.com/images/svg/refer_icon.svg" alt="Referral">
                    </div>
        ...
        <a href="tel:<?php echo $row["user_phonenumber"]; ?>" class="button-big duo-bg phone-btn">
            <div class="flexxer just-center">
                <div class="callbtn_icon">
                    <img src="https://dev.connextusnow.com/images/ux/Connextus_call_phoneIcon1.svg" alt="Call" width="30">
                </div>
                <div class="callbtn_icon">
                    <img src="https://dev.connextusnow.com/images/ux/connextus_textlogoW.svg" alt="ConneXtus" width="150">
                </div>
                <div class="callbtn_icon">
                    <img src="https://dev.connextusnow.com/images/ux/Connextus_logoSmall_whiteborder1.svg" alt="Logo" width="30" style="border: 2px solid #ffffff; border-radius:5px">
                </div>
            </div>
        </a>
        </div>
        ...
        <div class="container P-2vh">
            <div class="flexxer just-around align-center">
                <a href="<?php echo $row["profile_sm1"]; ?>" target="_blank"
                    class="">
                    <img src="https://dev.connextusnow.com/images/sm/Connextus_linkedinLogo.svg"
                        alt="Linkedin" width="20px">
                </a>
                <a href="<?php echo $row["profile_sm2"]; ?>" target="_blank" class="">
                    <img src="https://dev.connextusnow.com/images/sm/Connextus_instagramLogo.svg" alt=""
                        width="20px">
                </a>
                <a href="<?php echo $row["profile_sm3"]; ?>"
                    target="_blank" class="">
                    <img src="https://dev.connextusnow.com/images/sm/Connextus_facebookLogo.svg" alt=""
                        width="20px">
                </a>
                <a href="https://twitter.com/intent/tweet?text=ConneXtusisagreattooltomeetbusinessaquantancies!&url=alt.connextusnow.com" target="_blank">
                    <img src="https://dev.connextusnow.com/images/sm/Connextus_twitterLogo.svg" alt=""
                        width="25px">
                </a>
