...
$meeting_date_formatted = date( 'l jS \of F Y h:i:s A', $meeting_date_format);


$swap_var = array(
    "{EMAIL_LOGO}" => "../../../images/ux/Connextus_LogoSmall4web.png",
    "{NAME}" => "Wendy",
    "{MEETINGWITH_NAME}" => "$meeting_name",
    "{MEETINGWITH_EMAIL}" => "$meeting_email",
    "{MEETINGWITH_PHONE}" => "$meeting_phone",
    "{MEETINGWITH_DATE}" => "$meeting_date_formatted",
...
$swap_var2 = array(
    ...
    "{MEETINGWITH_DATE2}" => "$meeting_date_formatted",
...
echo "<meta http-equiv=\"refresh\" content=\"3;URL=https://dev.connextusnow.com/users/demo/wendy/wendy.php\">";
