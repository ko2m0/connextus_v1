...
<div class="modal-content">
    ...
    <div class="modal-body">
        <div class="contact-form no-bottom">
            ...
            <form action="https://dev.connextusnow.com/php/demo/users/jimgarman/meet_db.php" method="post" class="meetingForm" id="meetingForm">
                <fieldset>
                    <!--
    ...
    <div class="modal-body">
        <div class="container no-bottom">
            <div class="contact-form no-bottom"> 
                ...
                <form action="https://dev.connextusnow.com/php/demo/users/jimgarman/refer_db.php" method="post" class="referralForm" id="referralForm">
                    <fieldset>
                        <!-- 
                        <div class="formValidationError" id="contactNameFieldError">
                            <div class="static-notification-red tap-dismiss-notification">
