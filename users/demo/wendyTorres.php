...
<body>
    ...
    <div class="container">
        <div class="container_iframe_video">
            <iframe class="responsive-iframe"
                src="<?php echo $row["profile_video"]; ?>"></iframe>
        </div>
    </div>
    <!-- -->
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="one-third">
                <a href="https://wa.me/<?php echo $row["user_phonenumber"]; ?>/?text=Hello%20I%20would%20like%20to%20contact%20you">
                    <div class="k-btn">
            ...
            <div class="modal-body">
                <div class="container no-bottom">
                    <div class="contact-form no-bottom"> 
                        ...
                        <form action="refer_db.php" method="post" class="referralForm" id="referralForm">
                            <fieldset>
                                <!-- 
                                <div class="formValidationError" id="contactNameFieldError">
                                    <div class="static-notification-red tap-dismiss-notification">
                                ...
                                -->
                                <div class="formFieldWrap">
                                    <label class="field-title referralNameField" for="referralNameField">Enter Referral Name:<span>(required)</span></label>
                                    <input type="text" name="referralNameField" value="" class="contactField requiredField" id="referralNameField"/>
                                </div>
                                <div class="formFieldWrap">
                                    <label class="field-title referralEmailField" for="referralEmailField">Enter Referral Email: <span>(required)</span></label>
                                    <input type="email" name="referralEmailField" value="" class="contactField requiredField referralEmailField" id="referralEmailField"/>
                                </div>
                                <div class="formFieldWrap">
                                    <label class="field-title referralFromField" for="referralFromField">Referral from: </label>
                                    <input type="text" name="referralFromField" value="" class="contactField requiredField requiredEmailField" id="referralFromField"/>
                                </div>
                                <div class="formTextareaWrap">
                                    <label class="field-title referralMsgField" for="referralMsgField">Message: <span>(required)</span></label>
                                ...
                                <div class="formSubmitButtonErrorsWrap">
                                    <input type="submit" class="buttonWrap button button-green contactSubmitButton" id="referralSubmitButton" value="SUBMIT" data-formId="referralForm"/>
                                </div>
                            </fieldset>
                        </form>       
                    </div>
