...
<div class="container">
    ...
    <iframe class="responsive-iframe" src="http://www.connextusnow.com/connextus_app/video/profile_video/wendyTorres.MP4"></iframe>
    </div>
</div>     
<!-- -->
...
<div class="content">
        ...
        <div class="container-flex">
            <div class="svgProfileMask">
                <svg viewBox="0 0 200 300" width="70" height="100">                    
                    ...
                    <image height="70%" preserveAspectRatio="xMinYMin slice" width="100%" xlink:href="http://www.connextusnow.com/connextus_app/img/users_demo/wendyTorres.jpg" clip-path="url(#clip)" />                    
                </svg>
                <!--    
    ...
    <div class="container">
        ...
        <ul class="gallery">
        <li><a class="" title="Client1"><img src="<?php echo $row["profile_client1"]; ?>" alt="img" /></a></li>
        <li><a class="" title="Client2"><img src="<?php echo $row["profile_client2"]; ?>" alt="img" /></a></li>
        <li><a class="" title="Client3"><img src="<?php echo $row["profile_client3"]; ?>" alt="img" /></a></li>
        <li><a class="" title="Client4"><img src="<?php echo $row["profile_client4"]; ?>" alt="img" /></a></li>
    </ul>
        </div>  
        <div class="clear"></div>     
    </div> 
    ...
    <div class="container ">
        <div class="flexxer just-around align-center">
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=alt.connextus.com" target="_blank" class="">
            <img src="http://www.connextusnow.com/connextus_app/img/SM/Connextus_linkedinLogo.svg" alt="Linkedin" width="20px">
            </a>
            <a href="<?php echo $row["profile_sm2"]; ?>" target="_blank" class="">
            <img src="http://www.connextusnow.com/connextus_app/img/SM/Connextus_instagramLogo.svg" alt="" width="20px">
            </a>
            <a href="https://www.facebook.com/sharer/sharer.php?u=alt.connextusnow.com&quote=Connextusmakesgreatbusinessconnections" target="_blank" class="">
            <img src="http://www.connextusnow.com/connextus_app/img/SM/Connextus_facebookLogo.svg" alt="" width="20px">
            </a>
            <a href="https://twitter.com/intent/tweet?text=ConneXtusisagreattooltomeetbusinessaquantancies!&url=alt.connextusnow.com" target="_blank" class="">
            <img src="http://www.connextusnow.com/connextus_app/img/SM/Connextus_twitterLogo.svg" alt="" width="20px">
            </a>
        </div>
        <div class="clear"></div>
    </div>
        <div class="container">
            ...
            <img src="http://www.connextusnow.com/connextus_app/img/Connextus_logoSmall.svg" alt="ConneXtus" width="80px">
            </div>
        <div class="clear"></div>
        </div>
