...
<div class="content">
    ...
    <div class="container no-bottom">
        ...
        <p>Don´t hesitate to contact me for any business inquiries, fill the fom below
            and I'll contact you ASAP.</p>
    </div>
            ...
            <form action="php/contact.php" method="post" class="contactForm" id="contactForm">
                <fieldset>
                    ...
                    <div class="formFieldWrap">
                        <label class="field-title contactNameField" for="contactNameField">Enter your Name:<span>(required)</span></label>
                        <input type="text" name="contactNameField" value="" class="contactField requiredField" id="contactNameField"/>
                    </div>
                    <div class="formFieldWrap">
                        <label class="field-title contactEmailField" for="contactEmailField">Enter your Email: <span>(required)</span></label>
                        <input type="email" name="contactEmailField" value="" class="contactField requiredField requiredEmailField" id="contactEmailField"/>
                    </div>
                    <div class="formFieldWrap">
                        <label class="field-title contactPhoneField" for="contactPhoneField">Enter your Phone Number: </label>
                        <input type="tel" name="contactPhoneField" value="" class="contactField requiredField requiredEmailField" id="contactEmailField"/>
                    </div>
                    <div class="formFieldWrap">
                        <label class="field-title contactDateField" for="contactDateField">Enter the Date you'd like to meet me: <span>(required)</span></label>
                        <input type="datetime-local" name="contactPhoneField" value="" class="contactField requiredField requiredEmailField" id="contactEmailField"/>
                    </div>
