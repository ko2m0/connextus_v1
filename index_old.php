...
-->
<a href="http://www.connextusnow.com/" target="_blank">
<img src="http://www.connextusnow.com/connextus_app/img/SM/Connextus_shareLogo4.svg" alt=""
width="25px">
</a>
            </div>
            <div class="clear"></div>
                    ...
                    <div class="contact-form no-bottom"> 
                        ...
                        <form action="/php/refer_db.php" method="post" class="referralForm" id="referralForm">
                            <fieldset>
                                ...
                                -->
                                <div class="formFieldWrap">
                                    <label class="field-title referralToNameField" for="referraltoNameField">Referral to Name:<span> (required)</span></label>
                                ...
                                <div class="formFieldWrap">
                                    <label class="field-title referralfromNameField" for="referralFromNameField">Referral from Name: </label>
                                    <input type="text" name="referralFromNameField" value="" class="contactField requiredField requiredEmailField" id="referralFromNameField"/>
                                </div>
                                <div class="formFieldWrap">
                                    <label class="field-title referralFromEmailField" for="referralFromEmailField">Referral from Email: </label>
                                    <input type="text" name="referralFromEmailField" value="" class="contactField requiredField requiredEmailField" id="referralFromEmailField"/>
                                </div>
                                <div class="formFieldWrap">
